...
export default function MessageCard({ message, onDelete }: MessageCardProps) {
  return (
    <div
      className={cn(
        "border rounded-lg px-2 py-3 bg-card inline-flex flex-col gap-1",
        message.isMine
          ? "self-end bg-teal-800 border-b-emerald-500 border-b-2"
          : "self-start bg-teal-700 border-b-emerald-300 border-b-2",
        "max-w-10/12 w-fit"
      )}
    >
      <div className="inline-flex items-center justify-between gap-4 p-2 pl-3">
        ...
        <span className="text-sm text-blue-2000">
